...
echo "   ${YELLOW}nano config/master_config.yaml${NC}"
echo "   (Edit portfolio.positions section - leave empty for pure opportunity scanning)"
echo ""
echo "3. Test the system:"
echo "   ${YELLOW}./scripts/run_master_scan.sh${NC}"
echo ""
...
echo "  ${YELLOW}./scripts/run_master_scan.sh${NC}       # Run daily market scan"
echo "  ${YELLOW}./scripts/run_premarket_scan.sh${NC}    # Run pre-market gap monitor"
echo ""
